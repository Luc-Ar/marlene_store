...
$titulo = 'Mi cuenta — Marlene STORE';
$estilos_extra = '
...
.cuenta-email { font-family: "Montserrat", sans-serif; font-size: 0.7rem; color: #999; margin-top: 4px; }
.btn-logout {
    padding: 10px 20px;
    background: none;
...
.btn-logout:hover { background: #FEE2E2; border-color: #DC2626; color: #DC2626; }
.cuenta-tabs {
    display: flex;
...
.tab-btn.activo { color: var(--marron); border-bottom-color: var(--marron); }
.tab-btn:hover { color: var(--marron); }
...
.pedido-card:hover { box-shadow: 0 8px 24px rgba(92,61,62,0.08); }
.pedido-numero { font-family: "Montserrat", sans-serif; font-size: 0.7rem; font-weight: 700; color: var(--marron); }
.pedido-fecha { font-size: 0.75rem; color: #999; margin-top: 3px; }
.pedido-estado {
    padding: 5px 12px;
    border-radius: 20px;
    font-family: "Montserrat", sans-serif;
...
.pedido-total { font-family: "Cormorant Garamond", serif; font-size: 1.4rem; font-weight: 700; color: var(--marron); text-align: right; }
.pedido-total-label { font-family: "Montserrat", sans-serif; font-size: 0.55rem; color: #999; text-transform: uppercase; letter-spacing: 1px; }
.sin-pedidos { text-align: center; padding: 60px 20px; color: #999; }
.sin-pedidos p:first-child { font-size: 3rem; margin-bottom: 12px; }
.datos-card {
    background: white;
    border: 1px solid rgba(200,152,154,0.2);
    border-radius: 10px;
...
.dato-item input, .dato-item select {
    width: 100%;
    padding: 10px 14px;
...
.dato-item input:focus, .dato-item select:focus { outline: none; border-color: var(--dorado); }
.btn-guardar {
    margin-top: 20px;
    padding: 12px 28px;
...
.exito-msg { background: #DCFCE7; color: #166534; padding: 10px 16px; border-radius: 6px; font-size: 0.8rem; margin-bottom: 16px; }
@media (max-width: 600px) {
    .cuenta-wrap { margin-top: 80px; }

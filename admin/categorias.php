...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-nuevo { background: #C9A96E; color: white; border: none; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: 700; font-size: 0.65rem; text-transform: uppercase; transition: 0.2s; }
        .btn-nuevo:hover { background: #5C3D3E; }

        .tabla-wrap { background: white; border-radius: 8px; border: 1px solid rgba(200,152,154,0.2); overflow: hidden; }
        table { width: 100%; border-collapse: collapse; }
        thead { background: #5C3D3E; }
        thead th { padding: 14px 16px; text-align: left; font-size: 0.6rem; text-transform: uppercase; color: #C9A96E; letter-spacing: 1px; }
        tbody td { padding: 14px 16px; font-size: 0.82rem; border-bottom: 1px solid #F9F5F0; vertical-align: middle; }
        tbody tr:hover { background: #FDFAF8; }

        .badge { padding: 4px 10px; border-radius: 20px; font-size: 0.58rem; font-weight: 700; text-transform: uppercase; }
        ...
        .btn-ver { background: #C9A96E; color: white; }
        .btn-ver:hover { background: #5C3D3E; }
        .btn-editar { background: #F2EBE0; color: #5C3D3E; border-color: rgba(200,152,154,0.3); }
        .btn-editar:hover { background: #e5ddd1; }
        .btn-pausar { background: #FEE2E2; color: #991B1B; }

        ...
        <div class="form-wrap">
            <div class="page-header">
                <div>
                    ...
                    <p style="font-size:0.8rem;color:#999;margin-top:4px;">Agregá una nueva sección al catálogo</p>
                </div>
                ...
                <div class="form-card">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nombre" id="nombre" required
                            placeholder="Ej: Mochilas Infantiles">
                    </div>
                    <div class="form-group">
                        <label>Slug (URL) *</label>
                        <input type="text" name="slug" id="slug" required
                            placeholder="mochilas-infantiles">
                        <div class="slug-preview">
                            marlene.store/catalogo?cat=<span id="slug-text">...</span>
                        </div>
                    </div>
                    <div class="form-group">

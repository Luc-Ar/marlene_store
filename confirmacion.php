...
$titulo = 'Pedido confirmado — Marlene STORE';
$estilos_extra = '
...
.btn-seguir:hover { background: var(--dorado); }
.btn-wsp-confirm {
    padding: 14px 28px;
    background: #25D366;
    color: white;
...
.btn-wsp-confirm:hover { background: #128C7E; }
';

// Sin panel de carrito en la página de confirmación
...
<!-- Limpiar carrito del localStorage al confirmar el pedido -->
<script>
